...
用法（在应用主流程里）：
    ...
    tray = Tray("ModelFlow 智模流水线", on_open=show_win, on_hide=hide_win, on_quit=quit_app)
...
class Tray:
    ...
    _HIDDEN_TITLE = "ModelFlowTrayHidden"
    _CLASS_NAME = "ModelFlowTrayWnd"

    def __init__(self, title="ModelFlow", on_open=None, on_hide=None, on_quit=None,
    ...
    def _app_icon(self):
        """获取应用图标句柄：
          - 打包后（frozen）：从 ModelFlow.exe 提取自带图标；
