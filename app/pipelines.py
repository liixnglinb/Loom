...
def builtin_pipelines():
    ...
    return [
        ...
        {
            "name": "competition_modex",
            "label": "国赛 · Modex 原版全流程",
            "desc": "Modex-MH-Agent 2.0 原版国赛流：赛题分析→建模求解(反馈检查点)→编程实现→图表→架构图→逻辑对抗复核→论文撰写→编译合规→改进循环。配套 9 个 Modex 原版技能（modex-*，我的技能区可编辑）。分析/编程/论文步骤带审批检查点。",
            "emoji": "🎯",
            "g": "comp",
            "builtin": 1,
            "steps": [
                {"key": "analysis", "label": "赛题分析", "skill": "modex-prob-analysis",
                 "out": "PROBLEM_ANALYSIS.md", "checkpoint": True, "role": "executor"},
                {"key": "modeling", "label": "建模求解", "skill": "modex-modeling",
                 "out": "MODELING_REPORT.md", "checkpoint": True, "role": "executor"},
                {"key": "code", "label": "编程实现", "skill": "modex-code",
                 "out": "RESULTS.md", "checkpoint": True, "role": "executor"},
                {"key": "figure", "label": "图表生成", "skill": "modex-figure",
                 "out": "FIGURES.md", "checkpoint": False, "role": "executor"},
                {"key": "arch", "label": "流程与架构图绘制", "skill": "modex-figure-html diagram-design",
                 "out": "ARCHITECTURE.md", "checkpoint": False, "role": "executor"},
                {"key": "review", "label": "逻辑对抗复核", "skill": "modex-review",
                 "out": "LOGIC_REVIEW.md", "checkpoint": False, "role": "reviewer"},
                {"key": "paper", "label": "竞赛论文撰写", "skill": "modex-paper-zh",
                 "out": "main.tex", "checkpoint": True, "role": "editor"},
                {"key": "compile", "label": "编译与合规检查", "skill": "modex-compile-zh",
                 "out": "main.pdf", "checkpoint": False, "role": "executor"},
                {"key": "improve", "label": "论文改进循环", "skill": "modex-improve-loop",
                 "out": "IMPROVED_PAPER.md", "checkpoint": False, "role": "executor"},
            ],
        },
    ]
