#!/usr/bin/env python3
"""
watchdog.py — Server-side unified monitoring daemon for MH Agent.
...
Usage:
    ...
    python3 watchdog.py [--base-dir /tmp/MH Agent-watchdog] [--interval 60]
...
DEFAULT_BASE = "/tmp/MH Agent-watchdog"
DEFAULT_INTERVAL = 60
...
def main():
    parser = argparse.ArgumentParser(description="MH Agent Watchdog — server-side task monitoring daemon")
