...
| **Architecture/pipeline diagrams** | ❌ No — manual | Model architecture, data flow diagrams, system overviews. At best can generate a rough TikZ skeleton, but **expect to draw these yourself** using tools like HTML 引擎, Figma, or TikZ |
...
- These require manual creation using HTML 引擎, Figma, Keynote, or TikZ
