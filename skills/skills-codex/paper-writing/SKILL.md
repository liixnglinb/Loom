...
> **Without `illustration: true`:** Architecture diagrams must still be created manually (HTML 引擎, Figma, TikZ) and placed in `figures/` before proceeding — same as before.
