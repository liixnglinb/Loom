...
- **FETCH_SCRIPT** - `tools/arxiv_fetch.py` relative to the MH Agent install, or the same path relative to the current project. Fall back to inline Python if not found.
