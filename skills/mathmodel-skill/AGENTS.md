...
- Preserve the trigger boundary: this skill is for the CUMCM (全国大学生数学建模竞赛) contest work, not generic data analysis or ordinary paper review.
- Treat official contest rules as time-sensitive. Keep a verification date and primary source in `competitions/mathmodel/current_rules.md`; official current-year material always overrides repository guidance.
