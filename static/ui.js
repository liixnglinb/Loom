...
const DICT = {
  zh: {
    ...
    'sb.liveN': '{n} 个在跑', 'sb.noLive': '当前没有在跑的任务', 'sb.flows': '项目', 'sb.recent': '最近运行', 'sb.newFlow': '新建项目',
    'sb.tagBuiltin': '内置', 'sb.tagMine': '自建', 'sb.noProject': '还没开工的项目 —— 去「工作流」挑一条跑起来',
    'sb.stepsN': '{n} 步', 'sb.toggle': '切换侧边栏',
    'foot.theme': '外观', 'foot.accent': '强调色', 'foot.lang': '语言', 'foot.engines': '智能体引擎',
    'up.grp': '更新', 'up.repo': '更新源仓库', 'up.repoD': '填 GitHub 的 owner/name；留空即关闭更新检查',
    'up.assetPh': '文件名包含', 'up.status': '更新状态', 'up.statusD': '当前版本 v{v}',
    'up.check': '检查更新', 'up.avail': '更新', 'up.ready': '已下载', 'up.failed': '更新失败',
    'up.downloading': '正在下载，请稍候', 'up.unknown': '未知', 'up.idle': '尚未检查',
    'up.notConfigured': '未配置更新源', 'up.checking': '正在检查…', 'up.needRepo': '先填 owner/name',
    'up.hasNew': '发现新版本 v{v}', 'up.isCurrent': '已是最新 v{v}',
    'up.downloadingPct': '下载中 {p}%', 'up.savedCheck': '已保存，最新版本 v{v}',
    'up.savedClear': '已清除更新源', 'up.checked': '{s}',
    'up.tipAvail': '发现新版本 v{v}（当前 v{cur}），点击开始下载',
    'up.tipDl': '下载中 {got} / {size}', 'up.tipReady': '已下载到：{p}', 'up.tipErr': '更新出错：{e}',
    'up.readyTip': '已下载到 {p}', 'up.errPrefix': '出错：{e}', 'up.readyAt': '更新包已在 {p}',
    'up.reqFail': '更新请求失败',
    ...
    'c.import': '导入', 'c.export': '导出', 'c.more': '更多操作', 'c.none': '无', 'c.builtin': '内置', 'c.user': '自建', 'c.steps': '个步骤', 'c.justNow': '刚刚',
    'c.minAgo': '{n} 分钟前', 'c.hourAgo': '{n} 小时前', 'c.dayAgo': '{n} 天前',
    'c.download': '下载',
    'c.words': '{n} 字', 'home.giveTask': '下任务', 'home.mineEmpty': '还没有自建流程 —— 复制一份内置流程改，或从零编排',
    ...
    'run.artifacts': '工作区文件', 'run.noArtifacts': '还没有文件 —— 智能体一开始写就会出现在这里', 'run.refresh': '刷新',
    ...
    'run.reviseEmpty': '请填写修改要求', 'run.reviseDone': '已按要求改写「{label}」', 'run.deleted': '已删除',
    'run.delConfirm': '确定删除这次运行？工作区产物一并删除。', 'run.notFound': '运行不存在',
    'run.toolUnit': '次工具', 'run.moreLines': '条更早的执行记录，点标题栏展开',
    ...
    'list.flows': '工作流', 'list.runned': '运行', 'list.restoreDone': '已恢复出厂步骤',
    'list.restoreConfirm': '把「{name}」的步骤清单恢复成出厂版本？你改过的顺序会被覆盖。',
    'list.duplicateName': '副本名称', 'list.deleteConfirm': '确定删除流程「{name}」？',
    ...
    'ed.saved': '流程已保存', 'ed.needName': '请填写流程名', 'ed.needLabel': '第 {n} 步缺步骤名称',
    ...
    'sk.newTitle': '新建技能', 'sk.editTitle': '编辑技能', 'sk.viewTitle': '查看技能',
    ...
    'sk.readonly': '内置技能只读 —— 请「另存为可编辑副本」后修改', 'sk.dupe': '另存为可编辑副本',
    'sk.dupeName': '副本名（英文小写）', 'sk.dupeDone': '已创建可编辑副本「{name}」',
    'sk.delConfirm': '确定删除自建技能「{name}」？引用它的步骤会读不到内容。', 'sk.deleted': '已删除',
    'sk.badgeUser': '自建·可编辑', 'sk.badgeBundled': '内置·只读', 'sk.empty2': '空',
    ...
    'set.runtime': '执行参数', 'set.library': '内置库', 'set.dirs': '本地目录', 'set.about': '关于',
    ...
    'set.libraryD': '出厂技能与流程模板可以随意改，改坏了能单独恢复。',
    ...
    'lib.version': '库版本', 'lib.versionD': '出厂技能与流程模板的版本号。',
    'lib.reset': '恢复出厂', 'lib.restore': '恢复出厂技能与流程',
    'lib.resetD': '把内置流程的步骤与 7 个出厂技能覆盖回原版；你自己新建的技能不受影响。',
    'lib.resetConfirm': '恢复出厂：内置流程步骤与 7 个出厂技能正文会被覆盖回原版。确认继续？',
    'lib.resetDone': '已恢复：技能 {n} 个、流程 {m} 条',
    'lib.skills': '技能库', 'lib.skillsD': '{n} 个技能，出厂技能可以直接改。',
    'lib.flows': '工作流模板', 'lib.flowsD': '{n} 条内置流程，单条也能恢复。',
    'lib.restoreOne': '恢复此条', 'lib.mine': '你新建的', 'dir.grpFolders': '目录',
    ...
    'sc.newTaskD': '随时唤出任务输入框，直接开一条新流程。',
    'sc.settingsD': '从任意页面跳到设置。', 'sc.closeD': '弹窗打开时优先关弹窗。',
    'sc.searchD': '只在设置页生效。', 'sc.sendD': 'Shift+Enter 换行。',
    'sc.toggleSbD': '折叠态会记住，重启后还是那样。',
    ...
    'st.none': '没有残留',
    'up.apply': '自动安装', 'up.applyD': '下载完成后是否由程序替换自身并重启',
  ...
  en: {
    ...
    'sb.liveN': '{n} running', 'sb.noLive': 'Nothing is running', 'sb.flows': 'Projects', 'sb.recent': 'Recent runs', 'sb.newFlow': 'New project',
    'sb.tagBuiltin': 'Built-in', 'sb.tagMine': 'Mine', 'sb.noProject': 'No projects yet — run a workflow to start one',
    ...
    'up.grp': 'Updates', 'up.repo': 'Update source repo', 'up.repoD': 'GitHub owner/name; leave empty to disable checks',
    'up.assetPh': 'filename contains', 'up.status': 'Update status', 'up.statusD': 'Running v{v}',
    'up.check': 'Check now', 'up.avail': 'Update', 'up.ready': 'Downloaded', 'up.failed': 'Update failed',
    'up.downloading': 'Downloading, please wait', 'up.unknown': 'Unknown', 'up.idle': 'Not checked yet',
    'up.notConfigured': 'No update source configured', 'up.checking': 'Checking…', 'up.needRepo': 'Enter owner/name first',
    'up.hasNew': 'New version v{v}', 'up.isCurrent': 'Up to date (v{v})',
    'up.downloadingPct': 'Downloading {p}%', 'up.savedCheck': 'Saved, latest is v{v}',
    'up.savedClear': 'Update source cleared', 'up.checked': '{s}',
    'up.tipAvail': 'v{v} available (you have v{cur}) — click to download',
    'up.tipDl': 'Downloading {got} / {size}', 'up.tipReady': 'Downloaded to: {p}', 'up.tipErr': 'Update error: {e}',
    'up.readyTip': 'Downloaded to {p}', 'up.errPrefix': 'Error: {e}', 'up.readyAt': 'Update package at {p}',
    ...
    'c.import': 'Import', 'c.export': 'Export', 'c.more': 'More actions', 'c.none': 'none', 'c.builtin': 'Built-in', 'c.user': 'Custom', 'c.steps': 'steps', 'c.justNow': 'just now',
    'c.minAgo': '{n} min ago', 'c.hourAgo': '{n} h ago', 'c.dayAgo': '{n} d ago',
    'c.download': 'Download',
    'c.words': '{n} chars', 'home.giveTask': 'Run task', 'home.mineEmpty': 'No custom workflow yet — duplicate a built-in one, or start from scratch',
    ...
    'run.artifacts': 'Workspace files', 'run.noArtifacts': 'No files yet — anything the agent writes shows up here', 'run.refresh': 'Refresh',
    ...
    'run.reviseEmpty': 'Enter a change request', 'run.reviseDone': 'Rewrote “{label}” as requested', 'run.deleted': 'Deleted',
    'run.delConfirm': 'Delete this run? Its workspace artifacts go too.', 'run.notFound': 'Run not found',
    'run.toolUnit': 'tool calls', 'run.moreLines': 'earlier lines — click the header to expand',
    ...
    'list.flows': 'Workflows', 'list.runned': 'Run', 'list.restoreDone': 'Factory steps restored',
    'list.restoreConfirm': 'Restore “{name}” to its factory step list? Your ordering is overwritten.',
    'list.duplicateName': 'Copy name', 'list.deleteConfirm': 'Delete workflow “{name}”?',
    ...
    'ed.saved': 'Workflow saved', 'ed.needName': 'Enter a workflow id', 'ed.needLabel': 'Step {n} has no name',
    ...
    'sk.newTitle': 'New skill', 'sk.editTitle': 'Edit skill', 'sk.viewTitle': 'Skill',
    ...
    'sk.readonly': 'Built-in skills are read-only — duplicate it first', 'sk.dupe': 'Save an editable copy',
    'sk.dupeName': 'Copy id (lowercase)', 'sk.dupeDone': 'Created editable copy “{name}”',
    'sk.delConfirm': 'Delete custom skill “{name}”? Steps referencing it will find nothing.', 'sk.deleted': 'Deleted',
    'sk.badgeUser': 'custom · editable', 'sk.badgeBundled': 'built-in · read-only', 'sk.empty2': 'empty',
    ...
    'set.runtime': 'Runtime', 'set.library': 'Built-in library', 'set.dirs': 'Local folders', 'set.about': 'About',
    ...
    'set.libraryD': 'Factory skills and workflows are editable, and each one can be restored.',
    ...
    'lib.version': 'Library', 'lib.versionD': 'Version stamp of the factory skills and workflow templates.',
    'lib.reset': 'Restore factory', 'lib.restore': 'Restore factory skills & workflows',
    'lib.resetD': 'Overwrites the built-in step lists and the 7 factory skills; your own skills are untouched.',
    'lib.resetConfirm': 'Restore factory: built-in step lists and the 7 factory skills get overwritten. Continue?',
    'lib.resetDone': 'Restored: {n} skills, {m} workflows',
    'lib.skills': 'Skill library', 'lib.skillsD': '{n} skills; factory ones stay editable.',
    'lib.flows': 'Workflow templates', 'lib.flowsD': '{n} built-in workflows, restorable one by one.',
    'lib.restoreOne': 'Restore', 'lib.mine': 'yours', 'dir.grpFolders': 'Folders',
    ...
    'sc.newTaskD': 'Opens the task box from anywhere.',
    'sc.settingsD': 'Jumps to settings from any page.', 'sc.closeD': 'Closes a dialog first when one is open.',
    'sc.searchD': 'Settings page only.', 'sc.sendD': 'Shift+Enter inserts a newline.',
    'sc.toggleSbD': 'The choice is remembered across restarts.',
    ...
    'up.apply': 'Auto-install', 'up.applyD': 'Replace the running program and restart once downloaded',
