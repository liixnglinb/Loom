...
const DICT = {
  zh: {
    ...
    'st.trend': '每日 Token 趋势', 'st.trendAria': '最近用量柱状图',
    'st.models': '模型用量', 'st.noData': '还没有可展示的数据',
    'st.noDataD': '当前区间暂无可展示的用量数据。',
    'st.msgs': '轮消息', 'st.cumTo': '累计', 'st.noModelInjected': '未注入端点',
    'st.reloaded': '用量数据已刷新', 'st.grpTrend': '趋势', 'st.grpModels': '模型',
    'st.heatGrpWeek': '按周分桶', 'st.heatGrpCum': '逐日累加',
    'set.caps': 'Agent 能力',
  ...
  en: {
    ...
    'st.msgs': 'messages', 'st.cumTo': 'Cumulative', 'st.noModelInjected': 'no endpoint injected',
    'st.reloaded': 'Usage data refreshed', 'st.grpTrend': 'Trend', 'st.grpModels': 'Models',
    'st.heatGrpWeek': 'Per week', 'st.heatGrpCum': 'Running total',
