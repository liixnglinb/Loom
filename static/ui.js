...
const DICT = {
  zh: {
    ...
    'sc.newTaskD': '随时唤出任务输入框，直接开一条新流程；用浏览器打开时 Ctrl K 会被地址栏抢走，改用 Ctrl+Shift+K。',
    'sc.settingsD': '从任意页面跳到设置。', 'sc.closeD': '弹窗打开时优先关弹窗。',
    'sc.searchD': '只在设置页生效。', 'sc.sendD': 'Shift+Enter 换行。',
    'sc.toggleSbD': '折叠态会记住，重启后还是那样；用浏览器打开时改用 Ctrl+Shift+B。',
  ...
  en: {
    ...
    'sc.newTaskD': 'Opens the task box from anywhere. In a browser the address bar keeps Ctrl+K — use Ctrl+Shift+K.',
    ...
    'sc.toggleSbD': 'Remembered across restarts. In a browser use Ctrl+Shift+B.',
