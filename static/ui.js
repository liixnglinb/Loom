...
const DICT = {
  zh: {
    ...
    'sc.newTaskD': '回到首页输入台，直接开一条新流程；用浏览器打开时 Ctrl+N 会被「新窗口」抢走，改用 Ctrl+Shift+N。',
  ...
  en: {
    ...
    'sc.newTaskD': 'Back to the home composer to start a run. In a browser Ctrl+N opens a new window — use Ctrl+Shift+N.',
